...
const RestaurantMenu = () => {
    ...
    const fetchMenu = async () => {
        try {
            const data = await fetch("https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=12.8899131&lng=77.6471693&restaurantId=376708&catalog_qa=undefined&isMenuUx4=true&submitAction=ENTER")
